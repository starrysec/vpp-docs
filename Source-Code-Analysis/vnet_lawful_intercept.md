...
合法监听功能是根据美国法律规定，所有的电信设备都必须提供设施用于对被选中的用户的呼叫进行监听（也被照搬到许多其它国家，尤其是欧洲）。
电信设备必须有一定程度的支撑，以便它能被建立在任何不同的网元中。按照相关的美国法律，“合法监听”的概念也被称为“通信协助执法”（CommunicationsAssistanceforLawEnforcementAct，简称：CALEA）。
